...
const paquetes_1000b = paquetesDatos.filter(paquete => paquete.tamaño>1000);
const paquetes_ordenados = paquetes_1000b.sort((a, b) => a.prioridad - b.prioridad);
console.log(paquetes_ordenados);